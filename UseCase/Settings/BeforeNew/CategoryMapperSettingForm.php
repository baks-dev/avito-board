...
namespace BaksDev\Avito\Board\UseCase\Settings\BeforeNew;
...
final class CategoryMapperSettingForm extends AbstractType
{
    public function __construct(
        private AvitoBoardFeedElementProvider $categoryProvider,
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults(
            [
                'data_class' => CategoryMapperSettingDTO::class,
                'method' => 'POST',
                'attr' => ['class' => 'w-100'],
            ],
        );
