...
namespace BaksDev\Avito\Board\UseCase\Settings\NewEdit\Elements;

use BaksDev\Avito\Board\Entity\Mapper\AvitoBoardMapperSettingInterface;
use BaksDev\Avito\Board\Type\Categories\AvitoBoardFeedElementInterface;
use BaksDev\Products\Category\Type\Section\Field\Id\CategoryProductSectionFieldUid;
use Doctrine\Common\Collections\ArrayCollection;
use Symfony\Component\Validator\Constraints as Assert;

final class MapperSettingElementDTO implements AvitoBoardMapperSettingInterface
{
    /**
