...
use BaksDev\Avito\Board\Type\Categories\AvitoBoardFeedElementProvider;
...
use BaksDev\Avito\Board\UseCase\Categories\NewEdit\Elements\MapperSettingElementForm;
...
final class MapperSettingForm extends AbstractType
{
    public function __construct(
        ...
        private readonly AvitoBoardFeedElementProvider                    $categoryProvider,
    ) {}
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
                                   'data_class' => AvitoBoardEventInterface::class,
                                   'method' => 'POST',
                                   'attr' => ['class' => 'w-100'],
                               ]);
    }
